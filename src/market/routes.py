...
def market_page():
    ...
    if request.method == "POST":
        ...
        if s_item_object:
            if current_user.can_sell(s_item_object):
                ...
                flash(f"Sorry you dont own this item {s_item_object.name}", category='danger')
    ...
    if request.method == "GET":
        ...
        return render_template('market.html', items=items, purchase_form=purchase_form, owned_items=owned_items, selling_form=selling_form,page = 'market')
